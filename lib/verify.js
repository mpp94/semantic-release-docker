...
async function verify(opts, context) {
  ...
  const registry = string.template(opts.registry)(env)
  const project = string.template(opts.projectj)(env)
  const name = string.template(opts.name)(env)
  console.log('opts logs1', opts)
  console.log('env logs1', env)
  console.log('registry logs1', registry)
  console.log('project logs1', project)
  console.log('name logs1', name)
